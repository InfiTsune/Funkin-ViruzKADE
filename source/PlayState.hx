...
class PlayState extends MusicBeatState
{
	...
	public static var ezMode:Bool = false;
	public static var botplay:Bool = false; //cheater
	...
	override public function create()
	{
		...
		FlxG.camera.follow(camFollow, LOCKON, 0.05); //iconP1
	...
	override public function update(elapsed:Float)
	{
		...
		{
			if (songScore >= 0)
				scoreTxt.text = "Score: " + songScore + "(combo: " + combo + ")" + " Misses: " + misses + " Accuracy: " + truncateFloat(accuracy, 2) + "%";
			else
		...
		iconP1.setGraphicSize(Std.int(FlxMath.lerp(150, iconP1.width, 0.55)), Std.int(FlxMath.lerp(150, iconP1.height, 0.55)));
		iconP2.setGraphicSize(Std.int(FlxMath.lerp(150, iconP2.width, 0.55)), Std.int(FlxMath.lerp(150, iconP2.height, 0.55)));
	...
	var ICON_FUNNY_BOUCE:Bool = false;
	...
	override function beatHit()
	{
		...
		// test
		iconP2.setGraphicSize(Std.int(iconP2.width + 25), Std.int(iconP2.height + 25));
		iconP1.setGraphicSize(Std.int(iconP1.width + 25), Std.int(iconP1.height + 25));
